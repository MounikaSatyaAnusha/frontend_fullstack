      ...
      <div className="content">
        ...
        <div className="workshop-details" id="workshops">
          ...
          <div className="location">
            <h3>Location:</h3>
            <p>
              Located in the idyllic coastal paradise of Arambol, Goa, Svabodha offers a serene retreat experience just moments away from the sun-kissed shores of the Arabian Sea.
            </p>
          </div>
          <div className="price">
            <h3>Price:</h3>
            <p style={{ fontSize: "20px" }}>Rs.32,075/-</p>
          </div>
          <Link to={"/register"}>
