    ...
    <div>
      ...
      <div className="content">
        <div className="image">
          ...
          <img src="https://i.ibb.co/ZVrhtm9/653x490-2.jpg" alt="Yoga Pose 3" />
        ...
        <div className="workshop-details" id="workshops">
          ...
          <p>
            ...
            with breath-taking views of it from the house. All activities during the retreat are performed with the
          ...
          <div className="price">
            <h3>Price:</h3>
            <p style={{ fontSize: "20px" }}>Rs.160,579/-</p>
          </div>
          <Link to={"/register"}>
